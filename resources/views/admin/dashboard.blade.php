                                        ...
                                        <div class="card-body">
                                                <div class="d-flex static-widget">
                                                        <div class="flex-grow-1">
                                                                <h6 class="font-roboto">Transactions</h6>
                                                                <h2 class="mb-0 counter">{{ Helper::get_data('transactions')->count() }}</h2>
                                                        </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                                <div class="card o-hidden">
                                        <div class="card-body">
                                                <div class="d-flex static-widget">
                                                        <div class="flex-grow-1">
                                                                <h6 class="font-roboto">Visitors</h6>
                                                                <h2 class="mb-0 counter">{{ Helper::get_data('visitors')->count() }}</h2>
                                                        </div>
                                        ...
                                        <div class="card-body">
                                                <div class="d-flex static-widget">
                                                        <div class="flex-grow-1">
                                                                ...
                                                                <h2 class="mb-0 counter">{{ Helper::get_data('users')->count() }}</h2>
                                                        </div>
                                ...
                                <div class="widget-joins card widget-arrow">
                                        ...
                                        <div class="card-body">
                                                        ...
                                                        <div class="col-sm-6">
                                                                <div class="widget-card">
                                                                        <div class="d-flex align-self-center">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                        <h6>Today</h6>
                                                                                        <h5><span class="counter">{{ $transactionsToday }}</span><span class="font-primary">{{ $transactionsTodayYesterdayPersentase }}%</span></h5>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                                <div class="widget-card">
                                                                        <div class="d-flex align-self-center">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                        <h6>Month</h6>
                                                                                        <h5><span class="counter">{{ $transactionsMonth }}</span><span class="font-secondary">{{ $transactionsMonthLastMonthPersentase }}%</span></h5>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                                <div class="widget-card">
                                                                        <div class="d-flex align-self-center">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                        <h6>Week</h6>
                                                                                        <h5>{{ $transactionsWeek }}<span class="font-success">{{ $transactionsWeekLastWeekPersentase }}%</span></h5>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                                <div class="widget-card">
                                                                        <div class="d-flex align-self-center">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                        <h6>Year</h6>
                                                                                        <h5>{{ $transactionsYear }}<span class="font-danger">{{ $transactionsYearLastYearPersentase }}%</span></h5>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                ...
                                                <div class="code-box-copy">
                                                        <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#sale-detail" title="" data-bs-original-title="Copy" aria-label="Copy"><i class="icofont icofont-copy-alt"></i></button>
                                                </div>
                                        </div>
                                </div>
                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                                <div class="widget-card">
                                                                        <div class="d-flex align-self-center">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                        <h6>Today</h6>
                                                                                        <h5>{{ $visitorsToday }}<span class="font-roboto font-primary f-w-700"> {{ $visitorsTodayYesterdayPersentase }}%</span></h5>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                                <div class="widget-card">
                                                                        <div class="d-flex align-self-center">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                        <h6>Month</h6>
                                                                                        <h5>{{ $visitorsMonth }}<span class="font-roboto font-warning f-w-700"> {{ $visitorsMonthLastMonthPersentase }}%</span></h5>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                                <div class="widget-card">
                                                                        <div class="d-flex align-self-center">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                        <h6>Week</h6>
                                                                                        <h5>{{ $visitorsWeek }}<span class="font-roboto font-success f-w-700"> {{ $visitorsWeekLastWeekPersentase }}%</span></h5>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                                <div class="widget-card">
                                                                        <div class="d-flex align-self-center">
                                                                                ...
                                                                                <div class="flex-grow-1">
                                                                                        <h6>Year</h6>
                                                                                        <h5>{{ $visitorsYear }}<span class="font-roboto font-danger f-w-700"> {{ $visitorsYearLastYearPersentase }}%</span></h5>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
