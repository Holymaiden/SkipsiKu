...
<script src="{{ url('assets/js/twbsPagination/jquery.twbsPagination.min.js') }}"></script>
<!-- feather icon js-->
...
<script src="{{ url('assets/js/product-tab.js') }}"></script>
<script src="{{ url('assets/js/owlcarousel/owl.carousel.js') }}"></script>
<script src="{{ url('assets/js/modal-animated.js') }}"></script>
